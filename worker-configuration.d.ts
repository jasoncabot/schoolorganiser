/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 29903ad63446dfed9af082d25a924059)
...
interface __BaseEnv_Env {
	...
	PROCESS_ON_RECEIVE: string;
	SIGNING_KEY: string;
	PRIVACY_FORWARD_TO: string;
	HOUSEHOLD: DurableObjectNamespace<import("./src/index").Household>;
	ADDRESS: DurableObjectNamespace<import("./src/index").Address>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Household" | "Address";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SENDER_ADDRESS" | "PROCESS_ON_RECEIVE" | "SIGNING_KEY" | "PRIVACY_FORWARD_TO">> {}
}
